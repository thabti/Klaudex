...
//! - macOS: ~/Library/Application Support/rs.klaudex/threads.db
//! - Linux: ~/.local/share/klaudex/threads.db
//! - Windows: %APPDATA%/klaudex/threads.db
...
impl ThreadDatabase {
    ...
    fn db_path() -> Result<PathBuf, ThreadDbError> {
        ...
        Ok(data_dir.join("rs.klaudex").join("threads.db"))
    }
