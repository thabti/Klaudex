...
describe('BtwOverlay', () => {
  ...
  it('renders the question text when checkpoint is set', () => {
    useTaskStore.setState({
      ...
      tasks: { 'task-1': { id: 'task-1', name: 'Test Task', createdAt: '2024-01-01T00:00:00Z', status: 'running', messages: [], workspace: '/ws' } },
  ...
  it('renders assistant response when available', () => {
    ...
    useTaskStore.setState({
      selectedTaskId: 'task-1',
      tasks: { 'task-1': { id: 'task-1', name: 'Test Task', createdAt: '2024-01-01T00:00:00Z', status: 'running', messages: msgs, workspace: '/ws' } },
      btwCheckpoint: { taskId: 'task-1', messages: [], question: 'test' },
    })
    render(<BtwOverlay />)
