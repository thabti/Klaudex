...
const FRECENCY_KEY = 'klaudex:command-frecency'
  ...
  const items = useMemo((): CommandItem[] => {
    ...
    const gitCommands: CommandItem[] = [
      {
        ...
        action: () => {
          ...
          window.dispatchEvent(new CustomEvent('klaudex:open-commit-dialog'))
          onClose()
        },
        category: 'git',
      },
      {
        ...
        action: () => {
          window.dispatchEvent(new CustomEvent('klaudex:git-push'))
          onClose()
        },
        category: 'git',
      },
      {
        ...
        action: () => {
          window.dispatchEvent(new CustomEvent('klaudex:git-pull'))
          onClose()
        },
        category: 'git',
      },
      {
        ...
        action: () => {
          window.dispatchEvent(new CustomEvent('klaudex:git-fetch'))
          onClose()
        },
        category: 'git',
      },
      {
        ...
        action: () => {
          window.dispatchEvent(new CustomEvent('klaudex:git-stash'))
          onClose()
        },
        category: 'git',
      },
      {
        ...
        action: () => {
          window.dispatchEvent(new CustomEvent('klaudex:show-git-history'))
          onClose()
        },
        category: 'git',
      },
    ...
    const actions: CommandItem[] = [
      ...
      },
      {
        ...
        action: () => {
          window.dispatchEvent(new CustomEvent('klaudex:open-model-picker'))
          onClose()
        },
        category: 'action',
      },
      {
        ...
        action: () => {
          window.dispatchEvent(new CustomEvent('klaudex:show-shortcuts'))
          onClose()
        },
        category: 'action',
      },
      {
        ...
        action: () => {
          window.dispatchEvent(new CustomEvent('klaudex:fork-thread'))
          onClose()
        },
        category: 'action',
      },
