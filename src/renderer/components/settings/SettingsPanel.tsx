...
import { NAV as SHARED_NAV, NAV_GROUP_LABELS, SEARCHABLE_SETTINGS, type Section as SharedSection, type NavGroup } from './settings-shared'
...
export const SettingsPanel = () => {
  ...
  const navGroups = NAV.reduce<Array<{ group: NavGroup; items: typeof NAV[number][] }>>((acc, item) => {
