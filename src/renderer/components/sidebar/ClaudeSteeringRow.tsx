...
import type { ClaudeSteeringRule, ProjectFile } from '@/types'
...
export const SteeringRow = memo(function SteeringRow({ rule, onOpen }: { rule: ClaudeSteeringRule; onOpen: (v: ViewerState) => void }) {
