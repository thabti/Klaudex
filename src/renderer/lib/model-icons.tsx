...
export const AnthropicIcon = ({ size = 14, className }: IconProps): JSX.Element => {
  const id = useId()
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 600" width={size} height={size} className={className} aria-hidden>
      <defs><clipPath id={id}><rect width="500" height="600" x="0" y="0" /></clipPath></defs>
      <g clipPath={`url(#${id})`}>
        <g transform="matrix(1.45761,0,0,1.45761,265.367,317.039)">
          <g><g transform="matrix(-1,0,0,1,0,0)"><path fill="currentColor" d="M124.872,-2.098 C121.933,-31.071 121.463,-58.981 113.863,-83.37 C81.313,-222.739 -107.797,-222.6 -145.633,-84.076 C-201.448,150.349 133.689,84.831 124.872,-2.098z" /></g></g>
        </g>
        <g transform="matrix(1.45761,0,0,1.45761,265.367,317.039)">
          <g><g transform="matrix(-1,0,0,1,0,0)"><path fill="currentColor" d="M-9.994,160.678 C7.798,54.302 -74.528,-129.561 -145.633,-84.076 C-151.149,-63.764 -172.644,34.713 -119.418,131.246 C-95.27,175.043 -27.933,217.214 -9.994,160.678z" /></g></g>
        </g>
        <g transform="matrix(1.45761,0,0,1.45761,265.367,317.039)">
          <g><g transform="matrix(-1,0,0,1,0,0)"><path fill="currentColor" d="M-9.994,160.677 C51.057,211.092 133.831,189.493 94.958,103.345 C94.958,103.345 29.176,-50.213 -20.944,-22.834 C-74.722,6.544 -64.237,96.151 -9.994,160.677z" /></g></g>
        </g>
        <g transform="matrix(1.45761,0,0,1.45761,265.367,317.039)">
          <g><g transform="matrix(-1,0,0,1,0,0)"><path fill="currentColor" d="M100.242,105.752 C100.242,105.757 100.242,105.736 100.242,105.736 C156.154,126.169 161.723,86.208 149.883,66.353 C112.421,3.534 128.201,-32.828 113.863,-83.37 C81.313,-222.739 -15.528,40.717 100.242,105.752z" /></g></g>
        </g>
        <g transform="matrix(1.45761,0,0,1.45761,263.3,317.039)">
          <g transform="matrix(1,0,0,1,17.992,-53.739)"><path fill="currentColor" d="M-18.456,-0.001 C-18.456,11.057 -16.138,29.607 -0.615,29.607 C-0.615,29.607 -0.612,29.607 -0.612,29.607 C11.327,29.607 18.456,18.54 18.456,-0.001 C18.456,-9.814 16.48,-17.707 12.741,-22.831 C9.459,-27.328 4.807,-29.607 -0.615,-29.607 C-6.037,-29.607 -10.3,-27.363 -13.28,-22.94 C-16.667,-17.913 -18.456,-9.981 -18.456,-0.001z" /></g>
        </g>
        <g transform="matrix(1.45761,0,0,1.45761,265.367,317.039)">
          <g transform="matrix(1,0,0,1,81.822,-53.739)"><path fill="currentColor" d="M-18.456,-0.001 C-18.456,11.057 -16.138,29.607 -0.615,29.607 C-0.615,29.607 -0.612,29.607 -0.612,29.607 C11.327,29.607 18.456,18.54 18.456,-0.001 C18.456,-9.814 16.48,-17.707 12.741,-22.831 C9.459,-27.328 4.807,-29.607 -0.615,-29.607 C-6.037,-29.607 -10.3,-27.363 -13.28,-22.94 C-16.667,-17.913 -18.456,-9.981 -18.456,-0.001z" /></g>
        </g>
      </g>
    </svg>
  )
